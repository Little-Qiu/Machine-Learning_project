...
X_train_small, y_train_small = X_train[:10000], y_train[:10000]  # 使用较小的子集进行实验
...
for sample_size in sample_sizes:
    ...
    # Step 7.2: 在训练集上评估性能
    y_train_pred = svm_classifier.predict(X_train_subset)
...
# Step 9: 输出最终性能
print(f'SVM Classifier Accuracy: {val_accuracies[-1]:.2f}%')
